  ...
  late List<ItemModel> items;
   late List<ItemModel>items2;
    ...
    initGame(){
      ...
      score=0; 
      items=[
        ItemModel(icon:FontAwesomeIcons.home,name:"Home", value:"Home"),
        ItemModel(icon:FontAwesomeIcons.dog,name:"dog", value:"dog"),
        ItemModel(icon:FontAwesomeIcons.car,name:"Car", value:"Car"),
    ...
    Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text('Alphabet Matching Game'),
        ),
                      ...
                      return Container(
                        ...
                        child: Draggable<ItemModel>(
                          ...
                          childWhenDragging: Icon(
                            ...
                            feedback: Icon(item.icon,color: Colors.cyan,size: 50,),
                            child: Icon(item.icon, color: Colors.cyan, size:50,),
                          ),
                        );
